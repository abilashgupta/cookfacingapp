    ...
    return Container(
      ...
      child: ListView(
        children: [
          ...
          CustomListTile(
              icon: Icons.restaurant, text: 'Order Food', onTap: () {print('tapped');}),
          CustomListTile(
              icon: OMIcons.receipt, text: 'Order History', onTap: () {print('tapped');}),
          CustomListTile(
              icon: Icons.home, text: 'TiffinBox Home', onTap: () {print('tapped');}),
          CustomListTile(
              icon: Icons.share,
              text: 'Share With Neighbours',onTap: () {print('tapped');}),
          CustomListTile(
              icon: Icons.settings, text: 'Settings', onTap: () {print('tapped');}),
          CustomListTile(
              icon: Icons.restaurant, text: 'Contact us', onTap: () {print('tapped');}),
          CustomListTile(icon: Icons.info, text: 'About Us', onTap: () {print('tapped');}),
